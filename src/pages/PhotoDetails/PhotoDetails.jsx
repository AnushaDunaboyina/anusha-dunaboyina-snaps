  ...
  return (
    <div className="photo-details">
      ...
      <div className="photo-details__info">
        <div className="photo-details__info-top">
          <div className="photo-details__likes">
            ...
            <p className="photo-details__likes-count">{photoData.likes} likes</p>
          </div>

          <p className="photo-details__photographer">Photo by {photoData.photographer}</p>
        </div>
